...
namespace Joy\VoyagerBreadSubscription\Models;
...
use Joy\VoyagerBreadSubscription\Database\Factories\SubscriptionFactory;
...
class Subscription extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Subscription'));
    }
